...
load(file='/gpfs/data1/lobodagp/dchen/Tony/Myanmar/Village_mapping/random_forest_model/random_forest_model_V7_tp2.RData')
...
for (hv in hvlist) {
  ...
  outfile=paste0(outpath, 'predicted_', hv, '_V7_tp2_prob.csv')
